        ...
        <>
         <TheHeader/>
          ...
          <main className="relative w-full h-[2510px] mlarge:h-auto bg-[#1f1f1f] overflow-hidden">
            <section className="relative grid mlarge:block grid-rows-2 grid-cols-10 justify-items-stretch justify-between gap-[20px] mt-[20px] mx-[2.5%] mlarge:mx-0 px-[12.5%] mlarge:px-[7.5%] py-[50px] mlarge:py-[30px] w-[95%] mlarge:w-full h-[850px] mlarge:h-[1440px] mmedium:h-[1365px] bg-[#111111] rounded-t-[30px]">
                ...
                <div className="relative col-span-6 mlarge:mt-[20px] w-full h-[355px] mmedium:h-[325px] mlarge:bg-[url('/static/InfoPage/background/BackgroundGoldSmartCityMobileImage.png')] mlarge:bg-cover rounded-[30px] overflow-hidden">
                    ...
                    <div className="mlarge:absolute mlarge:mx-[10%] mlarge:bottom-[50px] px-[35px] py-[20px] w-[calc(50%-20px)] mlarge:w-[80%] h-[125px] bg-[#1f1f1f] rounded-[30px] z-20">
                        ...
                        <span className="block mt-[10px]">
                            <p className="goldMediumText text-[1rem]"><a href="https://yandex.ru/maps/213/moscow/house/prospekt_mira_119s461/Z04YcARgQEEPQFtvfXRycnVhYg==/?ll=37.630948%2C55.833926&z=17.12" className="underline outline-none">Адрес:</a> пр-т Мира, <br/> 119 строение 461</p>
                        </span>
                    </div>
                </div>
            </section>
